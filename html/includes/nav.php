			...
			<nav class="bg5">
				<div class="nav-wrapper  container">
			    	...
			    	<ul id="nav-mobile" class="right hide-on-med-and-down">
						...
						<li<?php if($inc==='rekrutacja'){ ?> class="active" <?php }  ?> ><a class="dropdown-trigger" data-target="dropdown1">Rekrutacja<i class="material-icons right">arrow_drop_down</i></a></li>
